...
extension AutoCarouselView {
    ...
    public struct Style {
        ...
        public func withInset(_ inset: NSDirectionalEdgeInsets) -> Style {
            validateStylingCustomisation(from: self.inset, to: inset)
            var style = self
        ...
        public func withDirection(_ direction: AutoCarouselDirection) -> Style {
            validateStylingCustomisation(from: self.direction, to: direction)
            var style = self
        ...
        public func withDuration(_ duration: CFTimeInterval) -> Style {
            validateStylingCustomisation(from: self.duration, to: duration)
            var style = self
        ...
        public func withDelay(_ delay: CFTimeInterval) -> Style {
            validateStylingCustomisation(from: self.delay, to: delay)
            var style = self
        ...
        public func withAnimationOption(_ option: AutoCarouselAnimationOptions) -> Style {
            validateStylingCustomisation(from: self.animationOption, to: option)
            var style = self
